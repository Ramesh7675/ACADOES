...
// session_start();
     ...
     $_SESSION['answer7']=$_POST['ans7'];}
     $cc1=$_SESSION['cc'];
     $sql = "SELECT * FROM `$cc1` WHERE `qno`=8 ";
     ...
     <form method="POST" action="9.php">
      <input type="text" id="bbb" placeholder="enter option" name="ans8">
     <br>
      <input type ="submit" id="bbb" name="submit8"value="submit&next"><br>
      <input type ="submit" id="bbb" name="submit107" value="next"><br><br>
      <input type ="reset" id="bbb" name="reset"><br>

</form>

<form action="7.php" method="POST">
<input type ="submit" id="bbb" name="submit7" value="previous"><br>
</form>
<?php 
if(isset($_POST['submit8'])){
$ram=$_SESSION['answer8'] ;
