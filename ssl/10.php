...
// session_start();
     ...
     $_SESSION['answer9']=$_POST['ans9'];}
     $cc1=$_SESSION['cc'];
     $sql = "SELECT * FROM `$cc1` WHERE `qno`=10 ";
     ...
     <input type="text" id="bbb" placeholder="enter option" name="ans10">
      <br>
      <input type ="submit" id="bbb" name="submit10"value="SUBMIT"><br>
      <input type ="reset" id="bbb" name="reset"><br>

</form>

<form action="9.php" method="POST">
<input type ="submit" id="bbb" name="submit9" value="previous"><br>
</form>
<?php 
if(isset($_POST['submit10'])){
$ram=$_SESSION['answer10'] ;
