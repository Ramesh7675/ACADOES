...
// session_start();
     ...
     $_SESSION['answer1']=$_POST['ans1'];}
     $cc1=$_SESSION['cc'];
     $sql = "SELECT * FROM `$cc1` WHERE `qno`=2 ";
     ...
     <form method="POST" action="3.php">
      <input type="text" id="bbb" placeholder="enter option" name="ans2">
      <br>
      <input type ="submit" id="bbb" name="submit2"value="submit&next">
      <br>
      <input type ="submit" id="bbb" name="submit101" value="next"><br>
      <input type ="reset" id="bbb" name="reset"><br>

</form>

<form action="1.php" method="POST">
<input type ="submit"  id="bbb" name="submit1" value="previous"><br>
</form>
<?php

if(isset($_POST['submit2'])){
 $ram=$_SESSION['answer2'] ;
