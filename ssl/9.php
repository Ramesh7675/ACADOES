...
// session_start();
     ...
     $_SESSION['answer8']=$_POST['ans8'];}
     $cc1=$_SESSION['cc'];
     $sql = "SELECT * FROM `$cc1` WHERE `qno`=9 ";
     ...
     <form method="POST" action="10.php">
      <input type="text" id="bbb" placeholder="enter option" name="ans9">
      <br>
      <input type ="submit" id="bbb" name="submit9" value="submit&next"><br><br>
      <input type ="submit" id="bbb" name="submit108" value="next"><br><br>
      <input type ="reset" id="bbb" name="reset"><br>

</form>

<form action="8.php"method="POST">
<input type ="submit" id="bbb" name="submit8" value="previous"><br>
</form>
<?php 
if(isset($_POST['submit9'])){
$ram=$_SESSION['answer9'] ;
