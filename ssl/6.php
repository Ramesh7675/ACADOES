...
// session_start();
     ...
     $_SESSION['answer5']=$_POST['ans5'];}
     $cc1=$_SESSION['cc'];
     $sql = "SELECT * FROM `$cc1` WHERE `qno`=6 ";
     ...
     <form method="POST" action="7.php">
      <input type="text" id="bbb" placeholder="enter option" name="ans6">
      <br>
      <input type ="submit" id="bbb" name="submit6"value="submit&next"><br><br>
      <input type ="submit" id="bbb" name="submit105" value="next"><br><br>
      <input type ="reset" id="bbb" name="reset"><br>

</form>

<form action="5.php" method="POST">
<input type ="submit" id="bbb" name="submit5" value="previous"><br>
</form>
<?php 
if(isset($_POST['submit6'])){
$ram=$_SESSION['answer6'] ;
