...
// session_start();
     ...
     $_SESSION['answer3']=$_POST['ans3'];}
     $cc1=$_SESSION['cc'];
     $sql = "SELECT * FROM `$cc1` WHERE `qno`=4 ";
     ...
     <form method="POST" action="5.php">
      <input type="text" id="bbb" placeholder="enter option" name="ans4">
      <br>
      <input type ="submit" id="bbb" name="submit4"value="submit&next"><br><br>
      <input type ="submit" id="bbb" name="submit103" value="next"><br><br>
      <input type ="reset" id="bbb" name="reset"><br>

</form>

<form action="3.php" method="POST">
<input type ="submit" id="bbb" name="submit3" value="previous"><br>
</form>
<?php 
if(isset($_POST['submit4'])){
$ram=$_SESSION['answer4'] ;
