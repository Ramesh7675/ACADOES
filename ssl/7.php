...
// session_start();
     ...
     $_SESSION['answer6']=$_POST['ans6'];}
     $cc1=$_SESSION['cc'];
     $sql = "SELECT * FROM `$cc1` WHERE `qno`=7 ";
     ...
     <form method="POST" action="8.php">
      <input type="text" id="bbb" placeholder="enter option" name="ans7">
      <br>
      <input type ="submit" id="bbb" name="submit7"value="submit&next"><br><br>
      <input type ="submit" id="bbb" name="submit106" value="next"><br><br>
      <input type ="reset" id="bbb" name="reset"><br>

</form>

<form action="6.php" method="POST">
<input type ="submit" id="bbb" name="submit6" value="previous"><br>
</form>
<?php 
if(isset($_POST['submit7'])){
$ram=$_SESSION['answer7'] ;
